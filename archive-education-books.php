<?php
/**
 * archive-education-books.php
 *
 * Archivo de archivo para `education-books`.
 * Propósito:
 * - Mostrar listados de libros de educación con estilos propios
...
<style>
    ...
    <section class="no-padding-y" style="min-height: 100px; background-image: url(<?php echo get_template_directory_uri() .'/img/biblio-indiana.jpg'; ?>); background-size: cover; background-position: center; position: relative;">
		...
		<div class="content" style="align-items: flex-start; justify-content: center; height: 300px; position: relative;">
			<h1 class="">LIBROS DE EDUCACIÓN</h1>
		</div>
	</section>
        		...
        		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                	...
                	<div class="entry-content">
                	    ...
                	    <div class="description">
                	        <?php 
                	            $amount = count(json_decode(get_post_meta(get_the_ID(), '_transparency_documents', true)));
                	        ?>
                	        <?php echo $amount ?> libros en total.
                	    </div>
